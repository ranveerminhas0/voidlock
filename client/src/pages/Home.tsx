      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <main className="flex-1 px-4 py-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="hidden lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
              <EncryptSection
                onEncrypt={setEncryptedEmoji}
                idSuffix="-desktop"
              />
              <DecryptSection
                initialEncrypted={encryptedEmoji}
                idSuffix="-desktop"
              />
            </div>
        ...
        <div className="border-t border-border">
          <div className="max-w-6xl mx-auto px-4 py-12 md:py-16 lg:py-20">
            ...
            <div className="mb-12 md:mb-16 lg:mb-20">
              <h2 className="text-3xl font-bold text-center mb-8 px-4">
                ...
                <Accordion type="single" collapsible className="space-y-3">
                  ...
                  >
                    <AccordionTrigger
                      ...
                      data-testid="faq-trigger-1"
                    >
                      {t.faqQuestion1}
                    </AccordionTrigger>
                    <AccordionContent
                      className="text-muted-foreground pb-4"
                      data-testid="faq-content-1"
                    >
                      {t.faqAnswer1}
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    <AccordionTrigger
                      className="hover:no-underline py-4 text-left"
                      data-testid="faq-trigger-2"
                    >
                      {t.faqQuestion2}
                    </AccordionTrigger>
                    <AccordionContent
                      className="text-muted-foreground pb-4"
                      data-testid="faq-content-2"
                    >
                      {t.faqAnswer2}
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    <AccordionTrigger
                      className="hover:no-underline py-4 text-left"
                      data-testid="faq-trigger-3"
                    >
                      {t.faqQuestion3}
                    </AccordionTrigger>
                    <AccordionContent
                      className="text-muted-foreground pb-4"
                      data-testid="faq-content-3"
                    >
                      {t.faqAnswer3}
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    <AccordionTrigger
                      className="hover:no-underline py-4 text-left"
                      data-testid="faq-trigger-4"
                    >
                      {t.faqQuestion4}
                    </AccordionTrigger>
                    <AccordionContent
                      className="text-muted-foreground pb-4"
                      data-testid="faq-content-4"
                    >
                      {t.faqAnswer4}
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    <AccordionTrigger
                      className="hover:no-underline py-4 text-left"
                      data-testid="faq-trigger-5"
                    >
                      {t.faqQuestion5}
                    </AccordionTrigger>
                    <AccordionContent
                      className="text-muted-foreground pb-4"
                      data-testid="faq-content-5"
                    >
                      {t.faqAnswer5}
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    <AccordionTrigger
                      className="hover:no-underline py-4 text-left"
                      data-testid="faq-trigger-6"
                    >
                      {t.faqQuestion6}
                    </AccordionTrigger>
                    <AccordionContent
                      className="text-muted-foreground pb-4"
                      data-testid="faq-content-6"
                    >
                      {t.faqAnswer6}
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    <AccordionTrigger
                      className="hover:no-underline py-4 text-left"
                      data-testid="faq-trigger-7"
                    >
                      {t.faqQuestion7}
                    </AccordionTrigger>
                    <AccordionContent
                      className="text-muted-foreground pb-4"
                      data-testid="faq-content-7"
                    >
                      {t.faqAnswer7}
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    <AccordionTrigger
                      className="hover:no-underline py-4 text-left"
                      data-testid="faq-trigger-8"
                    >
                      {t.faqQuestion8}
                    </AccordionTrigger>
                    <AccordionContent
                      className="text-muted-foreground pb-4"
                      data-testid="faq-content-8"
                    >
                      {t.faqAnswer8}
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    <AccordionTrigger
                      className="hover:no-underline py-4 text-left"
                      data-testid="faq-trigger-9"
                    >
                      {t.faqQuestion9}
                    </AccordionTrigger>
                    <AccordionContent
                      className="text-muted-foreground pb-4"
                      data-testid="faq-content-9"
                    >
                      {t.faqAnswer9}
                    </AccordionContent>
                  </AccordionItem>
                  ...
                  >
                    <AccordionTrigger
                      className="hover:no-underline py-4 text-left"
                      data-testid="faq-trigger-10"
                    >
                      {t.faqQuestion10}
                    </AccordionTrigger>
                    <AccordionContent
                      className="text-muted-foreground pb-4"
                      data-testid="faq-content-10"
                    >
                      {t.faqAnswer10}
                    </AccordionContent>
                  </AccordionItem>
            ...
            <div className="mb-12 md:mb-16 lg:mb-20 border-t border-border pt-12 md:pt-16 lg:pt-20">
              <div className="max-w-4xl mx-auto text-center px-4">
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                  ...
                  >
                    <a
                      href="https://github.com/ranveerminhas0/voidlock"
                      target="_blank"
